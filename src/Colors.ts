...
export const COLORS = {
  light: {
    ...
    // Card Background - Gentle pastel lavender
    cardBackground: '#F6F4FF',

    // Text Heading - Warm dark gray for readability
    textHeading: '#2D2A3D',

    // Text Body - Muted purple-gray for comfortable reading
    textBody: '#6B6B85',

    // Border - Soft pastel purple dividers
    border: '#E8E3FF',

    // Accent - Vibrant coral for energy against pastels
    accent: '#FF6B9D',
  },

  dark: {
    // Background - Rich charcoal gray
    background: '#1C1C1E',

    // Card Background - Elevated medium gray
    cardBackground: '#2C2C2E',

    // Text Heading - Pure white for clarity
    textHeading: '#FFFFFF',

    // Text Body - Soft light gray
    textBody: '#AEAEB2',

    // Border - Subtle gray separators
    border: '#38383A',

    // Accent - Bright coral that pops against gray
    accent: '#FF79A1',
  },
};
